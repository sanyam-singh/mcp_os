...
async def generate_weather_alert(crop: str, weather_data: dict, growth_stage: str, api_key: str):
    """
    ...
    response = await openai_llm.predict_weather_alert(prompt, api_key=api_key)
    return response
